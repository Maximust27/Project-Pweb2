...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="flex justify-between items-center">
            <p class="text-5xl font-bold text-gray-800">22</p>
            <div class="text-7xl"><svg width="100" height="100" viewBox="0 0 1121 805" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="flex justify-between items-center">
            <p class="text-10xl font-bold text-gray-800">12</p>
            <div class="text-7xl"><svg width="100" height="100" viewBox="0 0 739 661" fill="none" xmlns="http://www.w3.org/2000/svg">
