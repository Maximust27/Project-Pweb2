  ...
  <nav class="bg-[#1a1a1a] px-6 md:px-10 py-4 shadow-md">
    <div class="flex items-center justify-between">
      ...
      <div id="menu" class="hidden md:flex items-center space-x-10">
        ...
        <!-- Profile -->
        <button onclick="window.location.href='<?= base_url('profile') ?>'" class="flex items-center gap-2 bg-[#b88a00] text-white text-[15px] font-medium px-5 py-1.5 rounded-full hover:bg-[#c49c20] transition">
